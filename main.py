...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default='train', help='Choose between "train" or "inference"')
...
def main():
    ...
    if args.mode == 'train':
        print("[INFO] Loading Train/Valid Datasets ...")
    ...
    if args.mode == 'train':
        ...
        if test_dataset is None:
            print("No test dataset loaded. Exiting ...")    
            return
        ...
        for i, seed in enumerate(Config.SEEDS):
            ...
            model_infer = create_model_for_inference()
